...
%                              disp(SVacI)
              ...
              elseif all(SVacI == [1	1	1	0	0	0	0	1	0])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s},(%s).',citecode,author,title,journal,year);
              elseif all(SVacI == [1	1	1	0	0	0	0	1	1])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s},(%s). %s.\n',citecode,author,title,journal,year,publisher);
              elseif all(SVacI == [1	1	1	0	0	0	1	1	0])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s},(%s %s).',citecode,author,title,journal,month,year);
              elseif all(SVacI == [1	1	1	0	0	0	1	1	1])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s},(%s %s). %s.',citecode,author,title,journal,month,year,publisher);
              elseif all(SVacI == [1	1	1	0	0	1	0	1	0])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, pp. %s,(%s).',citecode,author,title,journal,pages,year);
              elseif all(SVacI == [1	1	1	0	0	1	0	1	1])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, pp. %s,(%s). %s.',citecode,author,title,journal,pages,year,publisher);
              elseif all(SVacI == [1	1	1	0	0	1	1	1	0])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, pp. %s,(%s %s).',citecode,author,title,journal,pages,month,year);
              elseif all(SVacI == [1	1	1	0	0	1	1	1	1])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, pp. %s,(%s %s). %s.',citecode,author,title,journal,pages,month,year,publisher);
              elseif all(SVacI == [1	1	1	0	1	0	0	1	0])
                  disp("Attention! THE VOLUME HAS TO BE ASSOCIATED WITH NUMBER, PLEASE CHECK!") 
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s,(%s).',citecode,author,title,journal,number,year);
              elseif all(SVacI == [1	1	1	0	1	0	0	1	1])
                  disp("Attention! THE VOLUME HAS TO BE ASSOCIATED WITH NUMBER, PLEASE CHECK!") 
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s,(%s). %s.',citecode,author,title,journal,number,year,publisher);
              elseif all(SVacI == [1	1	1	0	1	0	1	1	0])
                  disp("Attention! THE VOLUME HAS TO BE ASSOCIATED WITH NUMBER, PLEASE CHECK!") 
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s,(%s %s).',citecode,author,title,journal,number,month,year);
              elseif all(SVacI == [1	1	1	0	1	0	1	1	1])
                  disp("Attention! THE VOLUME HAS TO BE ASSOCIATED WITH NUMBER, PLEASE CHECK!") 
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s,(%s %s). %s.',citecode,author,title,journal,number,month,year,publisher);
              elseif all(SVacI == [1	1	1	0	1	1	0	1	0])
                  disp("Attention! THE VOLUME HAS TO BE ASSOCIATED WITH NUMBER, PLEASE CHECK!") 
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s, pp. %s,(%s).',citecode,author,title,journal,number,pages,year);
              elseif all(SVacI == [1	1	1	0	1	1	0	1	1])
                  disp("Attention! THE VOLUME HAS TO BE ASSOCIATED WITH NUMBER, PLEASE CHECK!") 
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s, pp. %s,(%s). %s.',citecode,author,title,journal,number,pages,year,publisher);
              elseif all(SVacI == [1	1	1	0	1	1	1	1	0])
                  disp("Attention! THE VOLUME HAS TO BE ASSOCIATED WITH NUMBER, PLEASE CHECK!") 
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s, pp. %s,(%s %s). %s.',citecode,author,title,journal,number,pages,month,year);
              elseif all(SVacI == [1	1	1	0	1	1	1	1	1])
                  disp("Attention! THE VOLUME HAS TO BE ASSOCIATED WITH NUMBER, PLEASE CHECK!") 
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s, pp. %s,(%s %s). %s.',citecode,author,title,journal,number,pages,month,year,publisher);
              elseif all(SVacI == [1	1	1	1	1	0	0	1	0])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s(%s),(%s).',citecode,author,title,journal,volume,number,year);
              elseif all(SVacI == [1	1	1	1	1	0	0	1	1])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s(%s),(%s). %s.',citecode,author,title,journal,volume,number,year,publisher);
              elseif all(SVacI == [1	1	1	1	1	0	1	1	0])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s(%s),(%s %s).',citecode,author,title,journal,volume,number,month,year);
              elseif all(SVacI == [1	1	1	1	1	0	1	1	1])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s(%s),(%s %s). %s.',citecode,author,title,journal,volume,number,month,year,publisher);
              elseif all(SVacI == [1	1	1	1	1	1	0	1	0])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s(%s), pp. %s,(%s).',citecode,author,title,journal,volume,number,pages,year);
              elseif all(SVacI == [1	1	1	1	1	1	0	1	1])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s(%s), pp. %s,(%s). %s.',citecode,author,title,journal,volume,number,pages,year,publisher);
              elseif all(SVacI == [1	1	1	1	1	1	1	1	0])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s(%s), pp. %s,(%s %s). %s.',citecode,author,title,journal,volume,number,pages,month,year);
              elseif all(SVacI == [1	1	1	1	1	1	1	1	1])
                  bibitem = sprintf('\\bibitem{%s}\n%s.\n\\newblock {%s.}\n\\newblock {\\emph %s}, %s(%s), pp. %s,(%s %s). %s.',citecode,author,title,journal,volume,number,pages,month,year,publisher);
              end 
